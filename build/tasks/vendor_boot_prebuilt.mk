...
$(INSTALLED_VENDOR_BOOTIMAGE_TARGET): device/google/zumapro/OrangeFox/Fox.img
	@echo "vendor_boot: using prebuilt device/google/zumapro/OrangeFox/Fox.img"
	$(hide) cp device/google/zumapro/OrangeFox/Fox.img $@
